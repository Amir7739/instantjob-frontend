...
import { RecentActivity } from "@/components/candidateDashboard/recent-activity"
import { RecommendedJobs } from "@/components/candidateDashboard/recommended-jobs"
import { UpcomingInterviews } from "@/components/candidateDashboard/upcoming-interviews"
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Card>
            <CardContent>
              ...
              <LinearProgress
                variant="determinate"
                value={loading ? 0 : parsePercentageChange(stats.jobsAppliedPercentageChange)}
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Card>
            <CardContent>
              ...
              <LinearProgress
                variant="determinate"
                value={loading ? 0 : parsePercentageChange(stats.savedJobsPercentageChange)}
                sx={{ mt: 2, height: 4, borderRadius: 2 }}
              />
            </CardContent>
          </Card>
